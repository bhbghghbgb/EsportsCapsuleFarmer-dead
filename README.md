...
- I wrote some custom code here for my use case and my findings after fidding around with devtools
- If you are interested, look at the AfrecaTV handler
- This tool found use again after riot started cracking down the API-only method. You can look for more info in the link below and the original project from which this one is forked (https://github.com/LeagueOfPoro/EsportsCapsuleFarmer)
